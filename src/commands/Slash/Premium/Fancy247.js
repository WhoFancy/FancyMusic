...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (data) {
            ...
            const off = new EmbedBuilder().setDescription(`<:off:1137051988761256028> | 247 Mode has been: \`Disabled\``).setColor(client.color);
            ...
            const on = new EmbedBuilder().setDescription(`<:onn:1137052088870912103> | 247 Mode has been: \`Enabled\``).setColor(client.color);
