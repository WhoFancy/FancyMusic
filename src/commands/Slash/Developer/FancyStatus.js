    ...
    run: async (client, message) => {
        ...
        cpuStat.usagePercent(function (err, percent, seconds) {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields([
                    { name: "\<:bot:1137048821810086030> | Client", value: `\`\`\`Servers: ${scount}\nChannels: ${ccount}\nUsers: ${mcount}\`\`\``, inline: false },
                    {
                        name: "<:cpu:1137048146594250882> | CPU",
                    ...
                    {
                        name: "<:database:1137042312472580138> | RAM",
                    ...
                    {
                        name: "<:discord:1137047438037889044> | Discord",
                        value: `\`\`\`Discord.js: v${version}\nNode: ${process.version}\nAPI Websocket Ping: ${Math.round(
                            client.ws.ping
                        )}ms\`\`\``,
                        inline: false,
                    },
                    { name: "<:system:1137047692531466351> | System", value: `\`\`\`Uptime: ${dDisplay + hDisplay + mDisplay + sDisplay}\`\`\``, inline: true },
                ])
