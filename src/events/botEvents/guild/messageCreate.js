...
module.exports.run = async (client, message) => {
    ...
    if (command.owner && message.author.id !== client.owner) {
        return message.reply({ content: `<:xx:1137053676486279259> | Only my owner can use this command!\n\n© Fancy 2023` });
    }
    ...
    try {
        ...
        return message.reply({ content: `<:xx:1137053676486279259> | Something went wrong.`, components: [row] });
    }
};
