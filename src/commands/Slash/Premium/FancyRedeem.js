    ...
    run: async (client, interaction) => {
        ...
        if (code) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Conratulations <:love_Zyrex:1118373145892638841> ${interaction.member}. You've successfully redeem premium code with the following details.`)
            ...
            if (user.premium.plan === "lifetime") {
                embed.addFields([
                    { name: `<:zyrex_Premium:1118366367603761294> | Redeemed By`, value: `\`\`\`${interaction.member.displayName}\`\`\``, inline: true },
                    { name: `<:plan_Zyrex:1118369070425849886> | Plan Type`, value: `\`\`\`${user.premium.plan}\`\`\``, inline: true },
                    { name: `<:active_Zyrex:1118370205840724020> | Expired Time`, value: `\`\`\`Never\`\`\``, inline: false },
                ]);
            } else {
                embed.addFields([
                    { name: `<:zyrex_Premium:1118366367603761294> | Redeemed By`, value: `\`\`\`${interaction.member.displayName}\`\`\``, inline: true },
                    { name: `<:plan_Zyrex:1118369070425849886> | Plan Type`, value: `\`\`\`${user.premium.plan}\`\`\``, inline: true },
                    { name: `<:active_Zyrex:1118370205840724020> | Expired Time`, value: `\`\`\`${expires}\`\`\``, inline: false },
                ]);
            }
